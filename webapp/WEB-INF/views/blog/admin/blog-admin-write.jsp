	...
	<div id="wrap">
		...
		<div id="content">
			<ul id="admin-menu" class="clearfix">
				...
				<li class="tabbtn"><a href="${pageContext.request.contextPath}/${bMap.blogVo.id}/admin/category">카테고리</a></li>
				<li class="tabbtn selected"><a href="${pageContext.request.contextPath}/${bMap.blogVo.id}/admin/writeForm">글작성</a></li>
			</ul>
			<!-- //admin-menu -->
			
			<div id="admin-content">
				<form action="${pageContext.request.contextPath}/${bMap.blogVo.id}/admin/write" method="get">
